...
#define x264_pixel_satd_8x16_sve x264_template(pixel_satd_8x16_sve)
#define x264_pixel_satd_8x8_sve x264_template(pixel_satd_8x8_sve)
...
#define x264_pixel_ssd_16x16_sve x264_template(pixel_ssd_16x16_sve)
#define x264_pixel_ssd_16x8_sve x264_template(pixel_ssd_16x8_sve)
...
#define x264_pixel_ssd_8x16_sve x264_template(pixel_ssd_8x16_sve)
...
int x264_pixel_sa8d_8x8_sve  ( uint8_t *, intptr_t, uint8_t *, intptr_t );
#define x264_pixel_sa8d_16x16_sve x264_template(pixel_sa8d_16x16_sve)
int x264_pixel_sa8d_16x16_sve( uint8_t *, intptr_t, uint8_t *, intptr_t );
#define x264_pixel_sa8d_satd_16x16_sve x264_template(pixel_sa8d_satd_16x16_sve)
uint64_t x264_pixel_sa8d_satd_16x16_sve( uint8_t *, intptr_t, uint8_t *, intptr_t );
...
uint64_t x264_pixel_var_8x8_sve  ( uint8_t *, intptr_t );
#define x264_pixel_var_8x16_sve x264_template(pixel_var_8x16_sve)
uint64_t x264_pixel_var_8x16_sve ( uint8_t *, intptr_t );
...
void x264_pixel_ssim_4x4x2_core_neon( const uint8_t *, intptr_t,
                                      ...
                                      int sums[2][4] );
#define x264_pixel_ssim_4x4x2_core_sve x264_template(pixel_ssim_4x4x2_core_sve)
void x264_pixel_ssim_4x4x2_core_sve( const uint8_t *, intptr_t,
                                      const uint8_t *, intptr_t,
                                      int sums[2][4] );
